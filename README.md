...
| Public port | `8101` |
| Release-synced version | `2.18.007` |
...
- the workspace manager now covers descriptor preview, structured editing, and the core descriptor lifecycle, but it is still not a full authoring suite with asset previews, deep library editing, or asset-level repair workflows
