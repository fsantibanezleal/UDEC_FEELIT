...
| Current validation surface | `87` automated tests passing plus browser smoke validation across the `5` routed pages |
...
- no probe or pilot payload currently drives force output, calibration, homing, acknowledgement, or a live scene-coupled servo loop
